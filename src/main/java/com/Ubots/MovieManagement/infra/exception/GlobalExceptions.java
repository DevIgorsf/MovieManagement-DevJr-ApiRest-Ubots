...
public class GlobalExceptions {
    ...
    public ResponseEntity tratarErro404(EntityNotFoundException e, HttpServletRequest request) {
    ...
    public ResponseEntity<StandardError> tratarErro400 (MethodArgumentNotValidException e, HttpServletRequest request) {
        StandardError erros = new StandardError(LocalDateTime.now(), 400, "Bad Request", e.getMessage(), request.getRequestURI());
